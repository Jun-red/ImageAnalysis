...
import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QDockWidget, QPushButton, QTextEdit, QVBoxLayout, QWidget
from PyQt5.QtCore import Qt
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("Toggle Sidebar Example")
        self.resize(800, 600)
    ...
    def toggle_sidebar(self):
        if self.is_sidebar_expanded:
            ...
            self.dock_widget.setMaximumWidth(200)  # 恢复为正常宽度
