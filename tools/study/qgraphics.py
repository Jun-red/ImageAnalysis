...
class ImageViewer(QGraphicsView):
    ...
    def __init__(self, parent=None):
        ...
        # 图片
        self.pixmap = QPixmap(r'C:\Users\12284\Desktop\GitHub\ImageAnalysis\images\background.png')
...
if __name__ == '__main__':
    ...
    # widgetHello = QtWidge
    # scene = QtWidgets.QGraphicsScene(0,0,480,280)
    # view = QtWidgets.QGraphicsView(widgethello)
    # view.setScene(scene)
    # view.setSceneRect(0,0,480,280)
