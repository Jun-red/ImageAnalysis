...
class MyVideo(qw.QMainWindow, Ui_Video.Ui_MainWindow, threading.Thread):
    ...
    #     self.pixmapItem = qw.QGraphicsPixmapItem()
    #     # 平滑缩放
    ...
    #     # 刷新图片
    #     self.pixmap = imagePath # QPixmap(imagePath)
    ...
    def cvimg_to_qtimg(self,cvimg):
        ...
        cvimg = qg.QImage(cvimg.data, width, height, width * depth, qg.QImage.Format_RGB888)
    ...
    def run(self):
        ...
        # 设置分辨率
        self.video_capture.set(cv2.CAP_PROP_FRAME_WIDTH, 1920)  # 设置宽度为 1280 像素
        self.video_capture.set(cv2.CAP_PROP_FRAME_HEIGHT, 1080)   # 设置高度为 720 像素
        ...
        while self.ThreadRun:
            ...
            pixmap = QPixmap.fromImage(self.cvimg_to_qtimg(frame))
            self.box4_graphics.setPixmap(pixmap)
